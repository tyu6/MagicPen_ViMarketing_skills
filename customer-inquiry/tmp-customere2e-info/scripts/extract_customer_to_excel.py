...
from shared.document_input import DEFAULT_ENCODINGS, DocumentReadError, SUPPORTED_INPUT_SUFFIXES, read_document_text
...
TEXT_SUFFIXES=set(SUPPORTED_INPUT_SUFFIXES)
